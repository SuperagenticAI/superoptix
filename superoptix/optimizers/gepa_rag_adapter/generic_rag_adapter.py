...
class GenericRAGAdapter(GEPAAdapter[RAGDataInst, RAGTrajectory, RAGOutput]):
    ...
    def make_reflective_dataset(
        ...
        for component in components_to_update:
            ...
            for traj, output, score in zip(
                ...
                example = self._create_component_example(
                    component, traj, output, score, candidate
                )
                if example:
    ...
    def _create_component_example(
        ...
        if component_name == "query_reformulation":
            return {
                ...
                "Feedback": self._generate_query_reformulation_feedback(
                    trajectory, score
                ),
            }
            ...
            return {
                "Inputs": {
                    ...
                    "retrieved_docs": [
                        doc["content"] for doc in trajectory["retrieved_docs"]
                    ],
                    "current_prompt": candidate.get(component_name, ""),
                },
                "Generated Outputs": trajectory["synthesized_context"],
                "Feedback": self._generate_context_synthesis_feedback(
                    trajectory, score
                ),
            }
            ...
            return {
                ...
                "Feedback": self._generate_answer_generation_feedback(
                    trajectory, output, score
                ),
            }
    ...
    def _generate_query_reformulation_feedback(
        self, trajectory: RAGTrajectory, score: float
    ) -> str:
    ...
    def _generate_context_synthesis_feedback(
        self, trajectory: RAGTrajectory, score: float
    ) -> str:
    ...
    def _generate_answer_generation_feedback(
        self, trajectory: RAGTrajectory, output: RAGOutput, score: float
    ) -> str:
    ...
    def _generate_reranking_feedback(
        self, trajectory: RAGTrajectory, score: float
    ) -> str:
